...
ビット演算に関する記号（ワード名）ついては C 言語
（この呼び方が気になる人は適当に C 等と読み替えて下さい）と同様です。
論理積を &amp; で、論理和を &verbar; 、排他的論理和を &circ; で表します。
ビットの反転は &sim; で、左シフトと右シフトはそれぞれ &lt;&lt; と &gt;&gt; になります。
